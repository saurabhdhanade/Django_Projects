...
def greetings(request):
    res = render(request,'yt_download/home.html')
    return res
...
def download(request):
    if request.method == 'POST':
        ...
        res = render(request,'yt_download/home.html',{"title":title,"thumbnail_url":thumbnail_url,"video_url":video_url})
        return res
    else:
        res = render(request,'yt_download/home.html')
        return res
...
def downloading(request):
    ...
    res = render(request,'yt_download/home.html',{"msg":"downloading completed"})
    return res